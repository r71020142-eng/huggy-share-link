      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold text-primary">{formatBRL(avgTicket)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">Recorrentes</p>
            <p className="text-2xl font-bold">{recurrents}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardContent className="p-4 space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Use {"{nome}"} para inserir o nome do cliente. Clique no ícone do WhatsApp em cada cliente para enviar.
          </p>
        </CardContent>
      </Card>
