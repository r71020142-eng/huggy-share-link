...
export default function Reports() {
  ...
  const fetchReports = async () => {
    ...
    orders.forEach((o) => {
      ...
      if (o.customer_phone) customerSet.add(o.customer_phone);
      else customerSet.add(o.customer_name);
    });
    ...
    <div className="space-y-6">
      ...
      <Tabs value={tab} onValueChange={setTab}>
        ...
        <TabsContent value="product">
          <p className="py-8 text-center text-muted-foreground">Relatório por produto em breve.</p>
        </TabsContent>
        <TabsContent value="customer">
          <p className="py-8 text-center text-muted-foreground">Relatório por cliente em breve.</p>
        </TabsContent>
      </Tabs>
    </div>
  );
